...
export class DataService {
  ...
  public getStatus() {
    return this.dataLoadService.load("FG_AC1045_STATUS")
  }
  ...
  public getBudgetDetails(PERIOD_NO) {
    ...
    return this.dataLoadService.load("FG_AC1045_GET_BUDGET_DETAIL", paramObj)
  }
  ...
  public removeBudgetEntry(BUDGET_NO) {
    let paramObj = {
      BUDGET_NO: BUDGET_NO
    } 
    return this.apiService.executeQuery<any>(`${this.serverPath}/remove-budget`, paramObj);
  }
}
