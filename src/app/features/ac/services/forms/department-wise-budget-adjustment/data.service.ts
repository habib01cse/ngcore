...
export class DataService {
  private serverPath = acConfig.url.apiUrl + 'ac1047';

  constructor(private apiService: BaseDataService,
    private dataLoadService: DataLoadService) { }

  // Get Pending Budget
  public getBudgetPendings(ACC_NO, PERIOD_NO) {
    let paramObj = {
      P_ACC_NO: ACC_NO,
      P_PERIOD_NO: PERIOD_NO
    }
    return this.dataLoadService.load("FG_AC1047_GET_BUDGET_PENDINGS", paramObj)
  }
  // // Get Transfer Dept
