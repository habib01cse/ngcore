...
export class ModelService {
  ...
  totalApproveAountSum(){
    this.totalAppAmt = 0;
    for (const iterator of this.budgetDetailsList) {
      if( (typeof iterator.APPROVE_AMT !== 'undefined')){
  ...
  totalAmountSumByAllSet(){
   ...
   // this.budgetList[this.selectedBudgetIndex].RCV_AMT = this.totalReqAmt;
  }
  totalAmountSumByOnChange(){
    ...
    this.budgetList[this.selectedBudgetIndex].APPROVE_AMT = this.totalAppAmt;
    //this.totalApproveAountSum();
  }
