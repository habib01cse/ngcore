...
export class ModelService {
  ...
  public relizationStatusList:any = [];
  public postTypeList:any = [];
  public reportInfoList:any = [];

  public salesRealizationTypeList:any = [];
  public selectedSalesRealizationType;
  ...
  constructor(
    ...
    this.salesRealizationTypeList = fixedValues.salesRealizationType;
  ...
  public totalNegotiationAmountSum(){
    ...
    for (const iterator of this.relizationStatusList) {
